module github.com/open-beagle/awecloud-bmq-server

go 1.20

replace github.com/fatedier/frp => github.com/open-beagle/awecloud-access v0.6.2-beagle.3

require (
	github.com/fatedier/frp v0.51.3
	github.com/gin-gonic/gin v1.9.1
	github.com/open-beagle/awecloud-bmq-sdk v0.1.1
